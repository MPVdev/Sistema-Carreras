...
<div class="contedor">
  ...
  <div class="contenido">
    <button id="btnMostrarJue" class="glow-on-hover">Nuevo</button>
    <div id="formJueDiv" style="display:none;" class="formulario">
      <form id="formJue" name="formJue">
        ...
        <button class="boton glow-on-hover" type="submit" id="btnEnviarJue" name="btnEnviarJue" style="width: 150px">Crear</button>
        <button class="boton glow-on-hover" type="reset" onClick="limpiar()" style="width: 150px">Limpiar</button>
      </form>
    </div>
    <div id="tbljueces">
      <table id="jueces" name="jueces" class="tablas">
        <thead>
          <tr>
            <th>Botones</th>
            <th>Cedula</th>
...
<script src="../js/Jueces.js"></script>
</html>